...
class LevelStore:
    ...
    def __init__(self, level: Levels = Levels.LEVEL1, all_sprites: Group = Group(), enemies: Group = Group()):
        self.change_level(level, all_sprites, enemies)

    def get_level(self):
        return self.__level__

    def change_level(self, level: Levels, all_sprites: Group, enemies: Group):
